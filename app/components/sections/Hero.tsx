    ...
    <div id='hero' className='relative h-screen max-w-5xl mx-auto flex flex-col p-4 pt-8 lg:pt-32 md:p-16'>
      <div className='flex flex-col md:flex-row items-center relative'>
        <div className='w-full h-full md:w-1/2 flex flex-col gap-8 z-10 bg-gradient-to-r from-satone-950 via-stone-950 to-transparent'>
          <h1 className='text-5xl md-text-6xl font-bold'>Your Keyboard<br/> Your Comfort</h1>
      ...
      <Link href='#catalog' className='absolute bottom-24 left-1/2 transform -translate-x-1/2 flex flex-row items-center px-6 py-2 mx-auto border border-slate-400 rounded-xl text-sm text-slate-400'>
        {/* FIXME */}
